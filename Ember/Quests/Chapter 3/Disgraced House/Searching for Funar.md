...
>
> During the [[Family Business]] Event, Lyla Cevher asks the party to find the location of her brother, Funar Cevher, giving them a [[Locator Rod]] attuned to the earring that he is wearing.
>
> Characters may use the Locator Rod to search for him from any location on the Region Map at any time, but will need to complete the search to trigger the [[Finding Funar]] Event.
>
> When the characters use the Locator Rod to search, refer to the instructions below to direct them.

### Using the Locator Rod

The Locator Rod has two modes — distance tracking and proximity tracking — and has 10 charges. When searching on the Region Map, it is set to distance tracking and its inset jewel is gray. Characters can use it with an action at any time, using one of the charges. Once all 10 charges have been used, they must return to Lyla so that she can recharge it.
...
When the party reaches Marlstone (the hex where Funar is located), the [[Family Business]] Event triggers.
